  ...
  return (
    <Box sx={{ maxWidth: 800, mx: 'auto', py: 3, px: 2 }}>
      ...
      <Typography paragraph>
        ...
        историю. При необходимости вы можете удалить любой отчёт из истории. Время генерации отчёта зависит от размера датасета.
        Среднее время генерации - 1 минута. Максимальное время генерации - 30 минут.
      </Typography>
      <Typography paragraph>
