  ...
  return (
    <Box sx={{ maxWidth: 800, mx: 'auto', py: 3, px: 2 }}>
      ...
      <Typography paragraph>
        ...
        Среднее время генерации - 1 минута. Максимальное время генерации - 35 минут.
      </Typography>
      <Typography paragraph>
      ...
      <Typography paragraph>
        Сгенерированный EDA-отчёт включает: сводную статистику по датасету, детальный анализ каждого признака с описательными метриками и
        визуализациями распределений, модуль анализа пропущенных значений с бар-чартом и матрицей совместных пропусков, матрицу
        корреляций Пирсона для выявления линейных зависимостей, автоматические предупреждения о проблемах качества данных (выбросы,
        дисбаланс, константные признаки).
      </Typography>
    </Box>
  )
}